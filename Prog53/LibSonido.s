...
; Rutina para meter un retardo en función del tipo de nota: redonda, blanca, ...

; El retardo se define por un número de iteraciones 1, 2, 4, 8, o 16
; y el número de milisegundos de cada iteración (tempo)
...
duracionNota:
        ...
        dec numIter
        bne duracionNota ; el bucle exterior son más o menos iteraciones
                         ; en función del tipo de nota: redonda, blanca, ...
...
dnBucle2:        
        ...
        dex
        bne dnBucle2 ; el bucle dnBucle2 es 1 milisegundo

        sec
        sbc #$01
        bne dnBucle1 ; el bucle dnBucle2 es N milisegundos (tempo)
